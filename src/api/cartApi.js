...
const cartApi = {
    getCart: async () => {
        try {
            ...
            console.log('[CartAPI] 购物车获取成功:', response.data);
    ...
    addToCart: async (productId, productVariantId, quantity, price) => {
        try {
            ...
            console.log('[CartAPI] 添加到购物车成功:', response.data);
            return response.data;
        } catch (error) {
    ...
    updateCartItemQuantity: async (cartItemId, quantity) => {
        try {
            ...
            console.log('[CartAPI] 更新购物车数量成功:', response.data);
            return response.data;
        } catch (error) {
    ...
    removeFromCart: async (cartItemId) => {
        try {
            ...
            console.log('[CartAPI] 删除购物车项成功:', response.data);
            return response.data;
        } catch (error) {
    ...
    removeProductFromCart: async (productId) => {
        try {
            ...
            const response = await apiClient.delete(`/cart/items/product/${productId}`);
            console.log('[CartAPI] 删除商品成功:', response.data);
            return response.data;
        } catch (error) {
    ...
    clearCart: async () => {
        try {
            ...
            console.log('[CartAPI] 清空购物车成功:', response.data);
            return response.data;
        } catch (error) {
